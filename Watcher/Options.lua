...
Watcher.changelog = [[
Update 3.0.9 (BfA 8.3.0)
	- bumped the addon version to 8.3.0.
	- A complete rewrite for Watcher, introducing a better UI as well as support for classic is underway and nearing a testable state!
